...
// import { generateAIContent } from "../services/aiGenerator"; // hypothetical service
...
Main Problem(s) Solved: {{pain_points}}
...
Product Description: {{product_description}}
Target Audience: {{target_audience}}
Core Topics / Industry Knowledge Areas: {{expertise_areas}}
Key Benefits / Features: {{benefits}}
Tone: {{tone}} (e.g., friendly, practical, authoritative, visionary)
...
Name: {{startup_name}}
Product Description: {{product_description}}
Mission / Vision Statement: {{mission_or_vision}}
Target Audience: {{target_audience}}
Key Benefits / Impact: {{benefits}}
Tone: {{tone}} (e.g., inspiring, bold, reflective, human)
Platform: {{platform}} (X or LinkedIn)
...
Main Problem(s) Solved: {{pain_points}}
Key Benefits / Features: {{benefits}}
Expertise / Niche Topics: {{expertise_areas}}
Tone: {{tone}} (e.g., friendly, practical, authoritative, energetic)
Platform: {{platform}} (X or LinkedIn)
...
Target Audience: {{target_audience}}
Expertise / Niche Topics: {{expertise_areas}}
Tone: {{tone}} (e.g., insightful, clear, relatable, visionary)
Platform: {{platform}} (X or LinkedIn)
...
Tone: {{tone}} (e.g., bold, insightful, friendly, no-nonsense)
...
- Product Description: {{product_description}}
- Target Audience: {{target_audience}}
- Industry / Niche Topics: {{industry_topics}}
- Tone: {{tone}} (e.g., witty, clever, playful, casual)
- Platform: {{platform}} (X or LinkedIn)
...
- Product Description: {{product_description}}
- Target Audience: {{target_audience}}
- Tone / Voice: {{tone}} (e.g., reflective, honest, witty, visionary)
...
Industry / Niche: {{industry}}
Product Description: {{product_description}}
Tone / Voice: {{tone}} (e.g., reflective, motivational, professional, witty)
Platform: {{platform}} (X or LinkedIn)
...
- Industry / Niche: {{industry}}
- Product Description: {{product_description}}
- Tone / Voice: {{tone}} (e.g., authentic, reflective, professional, warm, witty)
- Platform: {{platform}} (X, LinkedIn, etc.)
...
Tone / Voice: {{tone}} (e.g., playful, professional, witty, casual)
...
Tone / Voice: {{tone}} (e.g., bold, witty, reflective, professional)
...
Product Description: {{product_description}}
Target Audience: {{target_audience}}
Tone / Voice: {{tone}} (e.g., reflective, playful, professional, casual)
Platform: {{platform}} (X, LinkedIn, etc.)
      ...
      for (const prompt of prompts) {
        try {
          ...
          try {
            ...
            else if (Array.isArray(parsed)) posts = parsed;
            else if (typeof parsed === "string") posts = [{ content: parsed }];
          } catch {
